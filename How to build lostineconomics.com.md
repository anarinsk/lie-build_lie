...
![enter image description here](https://github.com/anarinsk/lie-build_lie/blob/master/assets/imgs/img_2.png?raw=True =300x)
...
![enter image description here](https://github.com/anarinsk/lie-build_lie/blob/master/assets/imgs/img_3.png?raw=True =300x)
...
![enter image description here](https://github.com/anarinsk/lie-build_lie/blob/master/assets/imgs/img_7.png?raw=True =400x)

- 싱크 버튼(원형 화살표)을 누르면 파일이 동기화된다. 즉 작업 중인 md 파일이 동기화된다. 
- 업로드 버튼을 누르면 publish가 구현된다. 즉 이미 지정해둔 파일 형식와 위치에 해당 파일이 푸시된다. 
![enter image description here](https://github.com/anarinsk/lie-build_lie/blob/master/assets/imgs/img_6.png?raw=True =400x)
...
![enter image description here](https://github.com/anarinsk/lie-build_lie/blob/master/assets/imgs/img_8.png?raw=True =400x)

![enter image description here](https://github.com/anarinsk/lie-build_lie/blob/master/assets/imgs/img_9.png?raw=True =400x)
...
![enter image description here](https://github.com/anarinsk/lie-build_lie/blob/master/assets/imgs/img_10.png?raw=True =400x)

:house:[lostineconomics.com](http://lostineconomics.com) | Jun Sok Huhh 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzc1MjMzNzk4XX0=
-->